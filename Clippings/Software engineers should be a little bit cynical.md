...
If you don’t have an slightly cynical explanation for why engineers write bad code in large tech companies - such as the one I write about [here](https://www.seangoedecke.com/bad-code-at-big-companies) - you risk adopting an overly cynical one. For instance, you might think that big tech engineers are being [deliberately demoralized](https://news.ycombinator.com/item?id=46082989) as part of an anti-labor strategy to prevent them from unionizing, which is nuts. Tech companies are simply not set up to engage in these kind of conspiracies.

If you don’t have a slightly cynical explanation for why large tech companies sometimes make inefficient decisions - such as [this one](https://www.seangoedecke.com/seeing-like-a-software-company) - you risk adopting an overly cynical one. For instance, you might think that tech companies are full of incompetent [losers](https://news.ycombinator.com/item?id=46133179), which is simply not true. Tech companies have a normal mix of strong and [weak engineers](https://www.seangoedecke.com/weak-engineers).
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/a-little-bit-cynical/&t=Software%20engineers%20should%20be%20a%20little%20bit%20cynical). Here's a preview of a related post that shares tags with this one.
...
> [Continue reading...](https://www.seangoedecke.com/you-cant-design-software-you-dont-work-on/)
...
[^2]: For some concrete details on this, see my post [*How I influence tech company politics as a staff software engineer*](https://www.seangoedecke.com/how-to-influence-politics). Also, if you’re interested, I wrote a much less well-developed version of this post right at the start of 2024, called [*Is it cynical to do what your manager wants?*](https://www.seangoedecke.com/cynicism).